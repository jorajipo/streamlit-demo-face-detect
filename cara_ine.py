...
st.title("Recorte de foto en credencial con OpenCV y Deep Learning")
img_file_buffer = st.file_uploader("Sube imagen de la credencial", type=['jpg', 'jpeg', 'png'])
...
if img_file_buffer is not None:
    ...
    conf_threshold = st.slider("Establece el umbral de Confianza", min_value=0.0, max_value=1.0, step=.01, value=0.5)
    ...
    st.markdown(get_image_download_link(out_image, "face_output.jpg", 'Descargar Imagen recortada'),
